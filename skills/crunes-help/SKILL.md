---
name: crunes-help
description: Use when orienting yourself in a crunes project — which skill to invoke for a task, how to inspect a rune's API before calling it, how to verify the environment is working, or when you're stuck and need to know where to look.
---
